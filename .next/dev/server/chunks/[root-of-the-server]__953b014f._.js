...
"[project]/src/data/community.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/pages/api/seedCommunities.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$community$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/data/community.ts [api] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
async function handler(req, res) {
    ...
    try {
        for (const community of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$community$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["listaData"]){
            // 1️⃣ Inserir comunidade
            const { rows } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO communities (logo, title, description, website, mail, color)
         VALUES ($1,$2,$3,$4,$5,$6) RETURNING id`, [
            ...
            // 2️⃣ Inserir categorias
            for (const cat of community.categories){
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO community_categories (community_id, category) VALUES ($1, $2)`, [
                    communityId,
                    cat
                ]);
            }
        ...
        return res.status(200).json({
            message: "Comunidades inseridas com sucesso"
        });
    } catch (err) {
        console.error(err);
        return res.status(500).json({
            error: "Erro ao inserir comunidades"
        });
    }
}
__turbopack_async_result__();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__953b014f._.js.map