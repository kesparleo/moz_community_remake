...
const CommunityProfile = ({ theme, setTheme })=>{
    ...
    const community = listaData.find((item)=>item.title.toLowerCase().replace(/\s+/g, "-") === id);
...
_s(CommunityProfile, "XoaV8Wx7MJ+TMJUnC9LtgF2K+GU=", true, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__43ed069b._.js.map